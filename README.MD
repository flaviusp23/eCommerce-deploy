...
? signed cookies secure http only
mongoose virtuals for showing reviews related to a single product
mongo aggregation pipeline for reviews (average review, number of reviews) in atlas GUI
